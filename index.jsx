...
// Jalur pintas svg icons agar tidak perlu instalasi dependency eksternal lagi
const IconLayers = () => (
...
export default function PortfolioUkom() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F6F0] text-[#2C3E2B] font-sans antialiased">
      {/* HEADER SECTION */}
      <header className="border-b border-[#D1D7C4] bg-[#EAEFE0] sticky top-0 z-50 backdrop-blur-md bg-opacity-90">
        <div className="max-w-6xl mx-auto px-6 py-5 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-sm text-emerald-850 mt-0.5">Junior Agricultural Infrastructure and Facilities Analyst — Dinas Pertanian</p>
          </div>
          <div className="flex flex-wrap gap-2">
            <span className="px-3 py-1 bg-[#2C3E2B] text-white text-xs font-mono rounded-md shadow-sm">Mode: Marbot Inovator</span>
            <span className="px-3 py-1 bg-emerald-750 text-white text-xs font-mono rounded-md shadow-sm">Target: Ahli Madya</span>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-start">
          ...
          {/* COMPONENT DETAIL WORKSPACE (KANAN) */}
          {activeGrid && (
            <div className="lg:col-span-3 bg-white border border-[#D1D7C4] rounded-xl p-6 shadow-md transition-all duration-300">
              ...
              {/* 4. Lampiran Legalitas / Dokumen Pendukung */}
              <div>
